...
def generate_launch_description():
    ...
    robots = [
        {'name': 'tb1', 'x_pose': '-5.0', 'y_pose': '-0.5', 'z_pose': 0.01},
        {'name': 'tb2', 'x_pose': '5.0', 'y_pose': '-0.5', 'z_pose': 0.01},
        ]
    ...
    map_server=Node(package='nav2_map_server',
        ...
        #              },],
        parameters=[{'yaml_filename': 'src/turtlebot3_multi_robot/map/map_fin_b4.yaml'}],
        ...
        if last_action is None:
            ...
            spawn_turtlebot3_event = RegisterEventHandler(
                event_handler=OnProcessExit(
                    ...
                    on_exit=[spawn_robot5,
                            robot5_state_publisher,
                            bringup_cmd],
                )
            )
    ...
    for robot in robots:
        ...
        message = '{header: {frame_id: map}, pose: {pose: {position: {x: ' + \
            str(x_pose_modified) + ', y: ' + str(y_pose_modified) + \
